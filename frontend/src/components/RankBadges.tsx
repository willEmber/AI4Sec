...
export const SCI_COLORS: Record<string, string> = {
...
export const CCF_COLORS: Record<string, string> = {
...
export const BADGE_BASE =
  "inline-flex items-center px-1.5 py-0.5 text-xs font-semibold rounded-md border";
