...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    // Shared by every structured report view
    "report.view.structured": "Structured",
    "report.view.markdown": "Markdown",
    "report.col.metric": "Metric",
    "report.col.dataset": "Dataset",
    "report.col.value": "This paper",
    "report.col.baseline": "Baseline",
    "report.col.delta": "\u0394",
    "report.col.page": "Page",
    "report.audit.coverage": "{pct}% of claims cited",

    // Logic Lens \u2014 structured report
    "lens.core_idea": "Core idea",
    "lens.sec.overview": "Overview & motivation",
    "lens.sec.method": "Method deep-dive",
    "lens.sec.experiments": "Experiments & results",
    "lens.sec.assessment": "Critical assessment",
    "lens.stat.formulas": "Key formulas",
    "lens.stat.stages": "Pipeline stages",
    "lens.stat.datasets": "Datasets",
    "lens.stat.findings": "Quantified results",
    "lens.problem": "Problem",
    "lens.gap": "Gap in prior work",
    "lens.contributions": "Core contributions",
    "lens.pipeline": "Pipeline & modules",
    "lens.formulas": "Key formulas",
    "lens.formula_n": "Formula {n}",
    "lens.algorithm": "Key algorithm",
    "lens.complexity": "Complexity",
    "lens.datasets": "Datasets & metrics",
    "lens.col.dataset": "Dataset",
    "lens.col.metrics": "Metrics",
    "lens.col.measures": "What it measures",
    "lens.setup": "Reported setup",
    "lens.findings": "Key results",
    "lens.no_findings": "The report gives no quantified results.",
    "lens.takeaways": "What the numbers show",
    "lens.why": "Why it works",
    "lens.limitations": "Limitations & risks",
    "lens.repro": "Reproducibility",
    "lens.repro.score": "Reproducibility",
    "lens.repro.available": "Provided",
    "lens.repro.missing": "Missing",
    "lens.open_questions": "Open questions",
  ...
  zh: {
    ...
    // 所有结构化报告视图共用
    "report.view.structured": "结构化视图",
    "report.view.markdown": "Markdown 原文",
    "report.col.metric": "指标",
    "report.col.dataset": "数据集",
    "report.col.value": "本文",
    "report.col.baseline": "基线",
    "report.col.delta": "变化",
    "report.col.page": "页码",
    "report.audit.coverage": "{pct}% 陈述已带引用",

    // 逻辑透镜 —— 结构化报告
    "lens.core_idea": "核心思想",
    "lens.sec.overview": "概览与动机",
    "lens.sec.method": "方法深读",
    "lens.sec.experiments": "实验与结果",
    "lens.sec.assessment": "批判性评估",
    "lens.stat.formulas": "关键公式",
    "lens.stat.stages": "流程模块",
    "lens.stat.datasets": "数据集",
    "lens.stat.findings": "量化结果",
    "lens.problem": "问题",
    "lens.gap": "先前工作的空白",
    "lens.contributions": "核心贡献",
    "lens.pipeline": "流程与模块",
    "lens.formulas": "关键公式",
    "lens.formula_n": "公式 {n}",
    "lens.algorithm": "关键算法",
    "lens.complexity": "复杂度",
    "lens.datasets": "数据集与指标",
    "lens.col.dataset": "数据集",
    "lens.col.metrics": "指标",
    "lens.col.measures": "衡量什么",
    "lens.setup": "实验设置",
    "lens.findings": "关键结果",
    "lens.no_findings": "报告中未给出可量化的实验结果。",
    "lens.takeaways": "结果解读",
    "lens.why": "为何有效",
    "lens.limitations": "局限与风险",
    "lens.repro": "可复现性",
    "lens.repro.score": "可复现性",
    "lens.repro.available": "已提供",
    "lens.repro.missing": "缺失",
    "lens.open_questions": "开放问题",
