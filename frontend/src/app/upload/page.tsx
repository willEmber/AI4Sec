...
const MODES: { value: ReadingMode; label: string; description: string }[] = [
  {
    value: "snap",
    label: "Insight Snap",
    description: "30-second triage: contributions, findings, worth-reading assessment",
  },
  {
    value: "lens",
    label: "Logic Lens",
    description: "Deep analysis: formulas, algorithms, experiment reproduction checklist",
  },
  {
    value: "sphere",
    label: "Research Sphere",
    description: "Reference network: multi-paper comparison, research gaps",
  },
];
...
export default function UploadPage() {
  ...
  }, [file, mode, llmModel, router]);

  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      <h1 className="text-2xl font-bold mb-6">Upload & Analyze Paper</h1>
      ...
      >
        ...
        {file ? (
          ...
          <div>
            ...
            <p className="text-sm text-[var(--muted-foreground)]">Supports .pdf files</p>
          </div>
        )}
      </div>
      ...
      {/* Mode selection */}
      <div className="mb-6">
        <label className="block font-medium mb-3">Reading Mode</label>
      ...
      {/* Model selection */}
      <div className="mb-6">
        <label className="block font-medium mb-2">LLM Model (optional)</label>
        <input
          type="text"
          value={llmModel}
      ...
      >
        {uploading ? "Uploading & starting analysis..." : "Start Analysis"}
      </button>
    </div>
  );
}
